            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="category.php">About Us</a></li>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="aboutus_add_db.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                    <label for="exampleInputPassword1">About Title</label>
                    <textarea name="atitle" class="form-control" id="atitle"></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="adescription" class="form-control" id="adescription"></textarea>
                        </div>
