                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                          ...
                          <tr>
                            ...
                            <th><img src="images/categories/<?php echo $row['image']; ?>" alt="" width="150px"></th>
                            <th><?php echo $row['cname']; ?></th>
                            <th><?php echo $row['catdescription']; ?></th>
                            <th>
                            <?php
                            if ($row['status'] == 1) {
                              echo '<p><a href="category_activestatus.php?id=' . $row['id'] . '&status=0" class="btn btn-success">Active</a></p>';
                            } else {
                              echo '<p><a href="category_activestatus.php?id=' . $row['id'] . '&status=1" class="btn btn-danger">InActive</a></p>';
